...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.restoreDefaultButton = QtGui.QPushButton(Dialog)
        self.restoreDefaultButton.setGeometry(QtCore.QRect(220, 150, 111, 31))
        self.restoreDefaultButton.setObjectName(_fromUtf8("restoreDefaultButton"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.restoreDefaultButton.setText(_translate("Dialog", "Reset To Default", None))
        self.groupBox.setTitle(_translate("Dialog", "Editor Set To: ", None))
